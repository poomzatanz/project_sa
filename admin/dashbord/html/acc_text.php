...
<div id="wrapper">
	...
	$sql = "SELECT AVG(text_re)  as num ,pre_web.text_acc as month FROM pre_web  GROUP BY pre_web.text_acc ORDER by pre_web.text_acc";
    ...
    $sql = "SELECT AVG(text_re)/100  as num ,pre_web.text_acc as month FROM pre_web  GROUP BY pre_web.text_acc ORDER by pre_web.text_acc;";
    $result = $conn->query($sql);
    /* If there are results from database push to result array */
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex no-block">
                            <div>
                                <h2></h2>
                                <h1 data-shadow='dang!'>ค่าความถูกต้องในการวิเคราะห์ความรู้สึกเนื้อหากระทู้</h1>
                                <?php //echo $lable1; ?>
                            </div>
                            <div class="ml-auto">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="nav navbar-nav">
                        <br><br>
                        <li class="text-right" style="color:#fff ;font-size:25px;"><a href="text.php">กลับ</a></li>
                            <div class="ml-auto">
