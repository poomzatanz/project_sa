...
echo "<h2>".$row['topic']."</h2>";
	?>
		...
		<table id="customers" align="center">
			...
			<script src='https://kit.fontawesome.com/a076d05399.js'></script>
			 ...
			 $sqli = "SELECT coment1.text,web.time,web.link,coment1.text_a FROM web INNER JOIN coment1 ON web.pk_web = coment1.pk_web where web.pk_web = ".$get_id." ORDER BY SUBSTRING(time, 0, 2) DESC" ;
		    //echo $sqli;
	...
	<div class="container">
		<div class="row">
		<a href ="table_pos.php?page=<?php echo $get_page; ?>&ipp=<?php echo $get_ipp;?>"" style="font-size: 25px;">กลับ</a>
	</div>
	</div>
</form>	
