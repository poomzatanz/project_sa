	...
	?>
		...
		<table id="customers" align="center">
            ...
            if($get_id == 'แง่บวก'){
                ...
                $sql_forms = $db->query("SELECT topic,time,texto,topic_acc,pk_web,text_acc FROM web  WHERE topic_acc = 'positive'");
			 ...
			 $sqli = "SELECT topic,time,texto,topic_acc,pk_web,text_acc FROM web  WHERE topic_acc = 'positive'".$pages->limit."";
		   //echo $sqli;
			...
			$result	=	$db->query($sqli);
                ...
                $pages = new Paginator;
                $pages->default_ipp = 10;
                $sql_forms = $db->query("SELECT topic,time,texto,topic_acc,pk_web,text_acc FROM web  WHERE topic_acc = 'negative'");
                $pages->items_total = $sql_forms->num_rows;
                $pages->mid_range = 10;
                $pages->paginate();	
             ...
             $sqli = "SELECT topic,time,texto,topic_acc,pk_web,text_acc FROM web  WHERE topic_acc = 'negative'".$pages->limit."";
                ...
                //echo $sqli;
                 ...
                 <?php
                        ...
                        $pages = new Paginator;
                        $pages->default_ipp = 10;
                        $sql_forms = $db->query("SELECT topic,time,texto,topic_acc,pk_web,text_acc FROM web  WHERE topic_acc = 'normal'");
                        $pages->items_total = $sql_forms->num_rows;
                        $pages->mid_range = 10;
                        $pages->paginate();	
                     ...
                     $sqli = "SELECT topic,time,texto,topic_acc,pk_web,text_acc FROM web  WHERE topic_acc = 'normal'".$pages->limit."";
