	...
	?>
		...
		<table id="customers" align="center">
            ...
            if($get_id == 'การศึกษา'){
                ...
                $sql_forms = $db->query("SELECT topic,time,texto,topic_acc,pk_web,text_acc FROM web  WHERE web.group = 'การศึกษา'");
			 ...
			 $sqli = "SELECT topic,time,texto,topic_acc,pk_web,text_acc FROM web  WHERE web.group = 'การศึกษา'".$pages->limit."";
		   //echo $sqli;
			...
			$result	=	$db->query($sqli);
							...
							<script src='https://kit.fontawesome.com/a076d05399.js'></script>
							 <td><?php 
                                 if($val['topic_acc'] == 'normal'){
									echo "	<i class='far fa-meh-blank' style='font-size:36px;color:#3e95cd;'></i>";
							 }else if($val['topic_acc'] == 'positive'){
								echo "	<i class='far fa-smile-beam' style='font-size:36px;color:#23E31D;'></i>";
							 }else {
								 echo "<i class='far fa-angry' style='font-size:36px;color:#FA6103;'></i>";
							 }
            ...
            }else if($get_id == 'อื่นๆ'){
                    
                $pages = new Paginator;
                $pages->default_ipp = 10;
                $sql_forms = $db->query("SELECT topic,time,texto,topic_acc,pk_web,text_acc FROM web  WHERE  web.group = 'อื่นๆ'");
                $pages->items_total = $sql_forms->num_rows;
                $pages->mid_range = 10;
                $pages->paginate();	
             ...
             $sqli = "SELECT topic,time,texto,topic_acc,pk_web,text_acc FROM web  WHERE web.group = 'อื่นๆ'".$pages->limit."";
                ...
                //echo $sqli;
                 ...
                 <?php
                    ...
                    }else if($get_id == 'หอพัก'){
                        $pages = new Paginator;
                        $pages->default_ipp = 10;
                        $sql_forms = $db->query("SELECT topic,time,texto,topic_acc,pk_web,text_acc FROM web  WHERE web.group = 'หอพัก'");
                        $pages->items_total = $sql_forms->num_rows;
                        $pages->mid_range = 10;
                        $pages->paginate();	
                     ...
                     $sqli = "SELECT topic,time,texto,topic_acc,pk_web,text_acc FROM web  WHERE web.group = 'หอพัก'".$pages->limit."";
                        ...
                        echo $sql_forms->num_rows;
                         ...
                         $result	=	$db->query($sqli);
                           ...
                           <?php                             
                            ...
                            }else if($get_id == 'กิจกรรม'){
                                $pages = new Paginator;
                                $pages->default_ipp = 10;
                                $sql_forms = $db->query("SELECT topic,time,texto,topic_acc,pk_web,text_acc FROM web  WHERE web.group = 'กิจกรรม'");
                                $pages->items_total = $sql_forms->num_rows;
                                $pages->mid_range = 10;
                                $pages->paginate();	
                             ...
                             $sqli = "SELECT topic,time,texto,topic_acc,pk_web,text_acc FROM web  WHERE web.group = 'กิจกรรม'".$pages->limit."";
                            ...
                            }else if($get_id == 'หาเพื่อน'){
                                $pages = new Paginator;
                                $pages->default_ipp = 10;
                                $sql_forms = $db->query("SELECT topic,time,texto,topic_acc,pk_web,text_acc FROM web  WHERE web.group = 'หาเพื่อน'");
                                $pages->items_total = $sql_forms->num_rows;
                                $pages->mid_range = 10;
                                $pages->paginate();	
                             ...
                             $sqli = "SELECT topic,time,texto,topic_acc,pk_web,text_acc FROM web  WHERE web.group = 'หาเพื่อน'".$pages->limit."";
