	...
	?>
		...
		<table id="customers" align="center">
			...
			<script src='https://kit.fontawesome.com/a076d05399.js'></script>
			 ...
			 $sqli = "SELECT coment1.text,web.time,web.link,pre_coment.text_a FROM web INNER JOIN coment1 ON web.pk_web = coment1.pk_web where web.topic = '".$get_id."' ORDER BY SUBSTRING(time, 0, 2) DESC" ;
		   //echo $sqli;
