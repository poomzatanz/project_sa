...
<div id="wrapper">
	...
	<form method="get" action="https://learncodeweb.com" class="form-inline my-2 my-lg-0">
		...
		<table id="customers" align="center">
			...
			$result	=	$db->query($sqli);
				...
				?>
				<tr>
					<td><?php echo $val['useid']; ?></td>
					<td><?php echo $val['login_status']; ?></td>
					<td align ="center"><a href ="edit_user.php?id=<?php echo mb_strtoupper($val['pk_user']);?>">คลิก</a></td>
					<td align ="center"><a href ="delete_user.php?id=<?php echo mb_strtoupper($val['pk_user']);?>">คลิก</a></td>
	...
	<div class="container">
		<div class="row">
		<a href = "insert_user.php" style="font-size: 25px;">เพิ่ม</a>
	</div>
	</div>
</form>	
