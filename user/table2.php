	...
	<h2><?php echo $get_id; ?></h2>
		...
		<table id="customers" align="center">
			...
			<script src='https://kit.fontawesome.com/a076d05399.js'></script>
				...
				$sqli = "SELECT coment1.text,web.time,web.link,coment1.text_a FROM web INNER JOIN coment1 ON web.pk_web = coment1.pk_web where web.topic = '".$get_id."' ORDER BY SUBSTRING(time, 0, 2) DESC" ;
...
<script>  
 $(document).ready(function(){  
	...
	<div class="container">
		...
		<div class="row">
		<?php
				$sqli = "SELECT COUNT(pre_coment.text) FROM pre_web INNER JOIN pre_coment ON pre_web.pk_web = pre_coment.pk_web where pre_web.pk_web = ".$get_id." ORDER BY SUBSTRING(time, 0, 2) DESC";
				$result	=	$db->query($sqli);
				while($val  =   $result->fetch_assoc()){ 
